...
<h3> Games</h3>
<p> I may not promote any of them, but a few are listed on the <a href="https://en.wikipedia.org/wiki/Public-domain_software"> PDS Wiki </a> page. </p>
...
effectively organize moving on the top priority projects? Perhaps, check out the <a href="https://github.com/mirrorsonthewall/public-domain-software-system/blob/master/NOTES.md">"NOTES.md" link </a>, 
and then <a href="https://github.com/mirrorsonthewall/public-domain-software-system/issues"> open an issue </a> if you have any feedback.</p>
